...
function Productlist() {
  ...
  const {values,errors,handleChange,handleBlur,touched,handleSubmit,resetForm}=useFormik({
  ...
  for (let i = 0; i < getAllShopProduct.length; i++) {
    data.push({
      ...
      color: getAllShopProduct[i]?.color[0]?._id,
        ...
        <div>
          {model ? (
            <div>
              ...
              <div
                className="product_model--data" ref={modelRef}
              >
                <h5 className="text-center text-white">Update Product</h5>
                <div className="row">
                  <div className="col-lg-4">
                    <UseInput type="text" label="Name" value={values.name}  name="name" onChange={handleChange} onBlur={handleBlur}/>
                    <div className="mt-2">
                      <UseInput type="text" label="Stack"  value={values.stack} name="stack" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <select
                        class="form-select"
                    ...
                    <div className="mt-2">
                      <UseInput type="text" label="Rewardpoint" 
                      name="rewardpoint"
                    ...
                    <div className="mt-2">
                      <UseInput type="text" label="Quantity"  name="quantity" onChange={handleChange} onBlur={handleBlur} value={values.quantity}/>
                    </div>

                    <div className="mt-2">
                      <UseInput type="text" label="Meta Title" name="meta_title" onChange={handleChange} onBlur={handleBlur} value={values.meta_title}/>
                    </div>
                    <div className="mt-2">
                      <UseInput type="text" label="Length" value={values.length} name="length" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <UseInput type="text" label="Height" value={values.height} name="height" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <UseInput type="text" label="Model" name="model" value={values.model} onChange={handleChange} onBlur={handleBlur} />
                    <div className="mt-2">
                      <UseInput type="text" label="Price" name="price" value={values.price} onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <select
                        class="form-select"
                    ...
                    <div className="mt-2">
                      <UseInput type="text" label="Tag"  value={values.tag} name="tag" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <h5></h5>
                    <div className="mt-2">
                      <UseInput type="text" label="Meta Description" value={values.meta_description} name="meta_description" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <UseInput type="text" label="Breadth" value={values.brether} name="brether" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <UseInput type="text" label="Weight" value={values.weight} name="weight" onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <UseInput type="text" label="SKU"  name="sku" onChange={handleChange} onBlur={handleBlur} value={values.sku}/>
                    <div className="mt-2">
                      <select
                        class="form-select"
                        aria-label="Default select example"
                    ...
                    <div className="mt-2">
                      <UseInput type="text" label="Sort" name="sort" value={values.sort} onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <select
                        class="form-select"
                    ...
                    <div className="mt-2">
                      <UseInput type="text" label="Meta Keyboard"  name="meta_keyboard" value={values.meta_keyboard} onChange={handleChange} onBlur={handleBlur}/>
                    </div>
                    <div className="mt-2">
                      <select
                        class="form-select"
                ...
                <div className="mt-2">
                  <UseInput type="text" label="Description"   name="description"
                      ...
                      >
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            <div {...getRootProps()}>
                              <input {...getInputProps()} />
                              <p className="text-center text-white" style={{padding:"20px",border:"1px solid white",borderRadius:"14px"}}>Upload Image</p>
                            </div>
                          </section>
                        )}
                      </Dropzone>
