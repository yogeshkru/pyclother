                    ...
                    <div className='container mt-5 delivery-address-leftside w-100'>
                        <form>
                            ...
                            <div className='d-flex deliver_address_liitems'>
                                ...
                                <div className=''>
                                    <button className='bg-white delivery_add_remove_btn text-center'>Remove</button> 
                                    <button className='bg-white delivery_add_remove_btn text-center'> Edite</button>
                                </div>
                            </div>
