          ...
          <div className="col-12 col-lg-6 deliver_address_borderleftline">
            <div className="d-flex justify-content-between">
              ...
              <div className="delivery_new_addr_btn">
                <button
                  type="submit"
                  class="btn btn-primary delivery-addnew-btn"
              ...
              <form>
                <div class="form-check">
                  <div>
                    ...
                    />
                    <label
                      class="form-check-label d-inline p-2"
                      for="flexRadioDefault2"
                    >
                      Name
                      <div className="d-inline p-2">
                        <p className="d-inline delivery-address-home">Home</p>
                      </div>
                    </label>
                  </div>
                </div>
                <div className="d-flex deliver_address_liitems">
                  <div className="ms-0">
                    <ul>
                      <li className="mt-2 delivery-address-liststyl">
                        60, this street punducherry
                        <br /> Villupuram , Tamil Nadu - 605101
                      </li>
                      <li className="mt-2 delivery-address-liststyl">
                        Mobile: 98765 43210
                      </li>
                  ...
                  <div className="d-inline-grid ms-4">
                    <button className="bg-white delivery_add_remove_btn text-center  border-0">
                      Remove
                    </button>
                    <button className="bg-white delivery_add_remove_btn  delivery_add_edite_btn text-center border-0">
                      {" "}
                      Edite
                    </button>
                  </div>
            ...
            <div className="delivery_order_details mt-4 mb-5">
              <div className="container mt-4">
                ...
                <div className="w-100 d-flex justify-content-center mb-3 p-3">
                  <button className="btn delivery-contine-btn text-white w-100">
                    Continue
                  </button>
                </div>
              </div>
              ...
              <div className="modal-body w-100">
                <form>
                  ...
                  <div className="mb-3 d-flex justify-content-between">
                    <div>
                      <button className="deliver_addres_point">
                        Pondicherry
                      </button>
                    </div>
                    <div>
